...
const ALLOWED_KEYS = [
  ...
  'hero_image', 'about_bio', 'about_site', 'cloud_provider_url'
];
...
const PUBLIC_KEYS = ['site_name', 'site_desc', 'nickname', 'avatar', 'github', 'email', 'icp', 'hero_image', 'about_bio', 'about_site', 'cloud_provider_url'];
